...
//using namespace std;
//
////Creating a function to obtain the <strong class="highlight">CPUID</strong>
//string GetCpuID()
//{
...
//	_asm
//	{
//		//Execute <strong class="highlight">CPUID</strong> with EAX = 0 to get the CPU producer
//		XOR EAX, EAX
//		CPUID
//
